...
async function load() {
  ...
  let inputs = await genInputs(url, "Organization");
  return {
    module: "Organization",
    inputs
  };
...
//# sourceMappingURL=16-9264a2f0.js.map
