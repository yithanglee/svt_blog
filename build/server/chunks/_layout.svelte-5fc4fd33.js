import { c as create_ssr_component, v as validate_component, a as compute_rest_props, b as createEventDispatcher, d as spread, e as escape_object, f as escape_attribute_value, g as add_attribute, h as getContext, s as setContext, i as compute_slots } from './ssr-5d41fc77.js';
import { twMerge } from 'tailwind-merge';
import { C as CloseButton, T as ToolbarButton, f as fade } from './CloseButton-7ff9a9d2.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: ({ hidden, toggle }) => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<img src="/images/2damienslab.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo"> <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-1ejjgw7">Svelte Admin</span>`;
        }
        ...
        default: () => {
          ...
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { class: nav_class, href: "/users" }, {}, {
            default: () => {
              return `Users`;
            }
  ...
  })}</div> <section class="mx-4 p-4"><div class="my-4">${slots.default ? slots.default({}) : ``}</div></section>`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-5fc4fd33.js.map
